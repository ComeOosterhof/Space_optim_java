...
public class Params {
	...
	/**
	 * File containing a description of all static data (satellites, users,
	 * stations)
	 */
	public final static String systemDataFile = "satellitePlanning/data/system_data_" + constellation + ".xml";
	/**
	 * File containing a description of all dynamic data (candidate acquisitions,
	 * recorded acquisitions...)
	 */
	public final static String planningDataFile = "satellitePlanning/data/planning_data_" + constellation + "_"
			+ horizon + ".xml";
	/**
